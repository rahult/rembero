...
export const metadata: Metadata = {
  title: "Rembero Playground — SQLite + Datalog IDE",
  description: "Run the Rembero SQLite extension in your browser and inspect exact results, proofs, lineage, and graphs.",
};
    ...
    <main>
      ...
      <section className="ide-afterword" aria-labelledby="afterword-title">
        ...
        <div className="afterword-ledger">
          ...
          <article><strong>The extension owns the query.</strong><p>The Rembero C extension is compiled into SQLite WebAssembly.</p></article>
      ...
      <section className="ide-final-cta"><h2>Build agents that can show their work.</h2><div><a className="button primary" href={github}>View the source</a><Link className="button secondary" href="/">Return to the main site</Link></div></section>
    </main>
  );
}
